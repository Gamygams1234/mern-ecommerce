    ...
    <div className="container">
      <div className="row mt-4">
        <div className="col-md col-xl-7 mb-4">
          ...
          <ul class="list-group">
            <li class="list-group-item">Transaction ID: {featuredOrder.transaction_id}</li>
            <li class="list-group-item">Total amount: ${featuredOrder.amount}</li>
            <li class="list-group-item">Ordered by: {featuredOrder.user.name}</li>
            <li class="list-group-item"> Ordered on: {moment(featuredOrder.createdAt).fromNow()}</li>
            ...
            ? featuredOrder.products.map((product, i) => (
                <div className="card mb-3" key={i}>
                  <div className="card-body">
                    <img src={`/api/products/photo/${product.product._id}`} class="card-img-top" alt="..." />
...
export default connect(mapStateToProps)(UserSingleOrder);
